    ...
    if (form_object["id_estado"] != 7) {
        Swal.fire({
            ...
            "html": 
                    ...
                    <br>
                    <div class="progress" title="Porcentaje de cumplimiento de la tarea: ${form_object["porc_cumplimiento"]}%">
                        <div class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" aria-label="Animated striped example" aria-valuenow="${form_object["porc_cumplimiento"]}" aria-valuemin="0" aria-valuemax="100" style="width: ${form_object["porc_cumplimiento"]}%"></div>
                    </div>
                    <small class="text-muted">Quedan ${form_object["diferencia_dias_fechas"]} días para el fin del plazo</small>
                    `,
            "icon": "success",
            "showCancelButton": true,
            "cancelButtonText": "Cancelar",
        ...
        Swal.fire({
            ...
            "html": 
                    ...
                    <br>
                    <div class="progress" title="Porcentaje de cumplimiento de la tarea:${form_object["porc_cumplimiento"]}%">
                        <div class="progress-bar progress-bar-striped progress-bar-animated bg-danger" role="progressbar" aria-label="Animated striped example" aria-valuenow="${form_object["porc_cumplimiento"]}" aria-valuemin="0" aria-valuemax="100" style="width: ${form_object["porc_cumplimiento"]}%"></div>
                    </div>
                    <small>Se acabo el plazo, la tarea está atrasada</small>
                    `,
            "icon": "warning",
